...
//   }
// }
const myInnerWidth = window.innerWidth
const myInnerHeight = window.innerHeight
const defineSize = (): number => {
  if (window.innerWidth < window.innerHeight) {//スマホのとき
    return 100 + Math.floor(((window.innerWidth) - (100 * 8)) / 8)
  }
...
export const App = () => {
  ...
  let tobasu12 = 0
  let tobasu3 = 0
  const bonrei = '11.1111vh'
  const bonreiXs = 12 / 9
  return (
    <>

      {(() => {
        if (myInnerHeight < myInnerWidth) {
          return <Grid container direction='row'>
            {/* 凡例側 */}
            <Grid container item xs={2} direction='column'  >
              {/* 1つ目の凡例 */}
              <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
              ...
              <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>レンガBrick</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <img src={img2png} width={imageLabelSize}></img>
                </Grid>
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>木Lumber</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>鉄Ore</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>麦Grain</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>羊Wool</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>砂漠Nothing</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>海Sea</h2>
                </Grid>
              </Grid>          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
                <Grid item xs={6} display='flex' justifyContent='center'>
                ...
                <Grid item xs={6} display='flex' justifyContent='center'>
                  <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', alignItems: 'center' }}>砂金Gold</h2>
                </Grid>
              </Grid>
            </Grid>
            {/* マップ側 */}
                  ...
                  (() => {
                    if (landView == 1) return <><h1 style={{ fontSize: imageSize / 6 }}>陸カタン</h1>
                      <svg width={imageSize * 5} height={imageSize * 5}>
                        {sigenRandom.map((sigen, index) => {
                          return <><image xlinkHref={svgList[sigen]} x={sigenCoordinate[index][0]} y={sigenCoordinate[index][1]} width={imageSize} height={imageSize} />
                  ...
                  (() => {
                    if (seaView == 1) return <>
                      ...
                      <svg width={imageSize * 8} height={imageSize * 7}>
                        ...
                        {sigenRandom.map((sigen, index) => {
                          return <><image xlinkHref={svgList[sigen]} x={sigenCoordinate1[index][0]} y={sigenCoordinate1[index][1]} width={imageSize} height={imageSize} />
                        ...
                        {sigenRandom2.map((sigen, index) => {
                          return <><image xlinkHref={svgList[sigen]} x={sigenCoordinate2[index][0]} y={sigenCoordinate2[index][1]} width={imageSize} height={imageSize} />
                        ...
                        {sigenRandom3.map((sigen, index) => {
                          return <><image xlinkHref={svgList[sigen]} x={sigenCoordinate3[index][0]} y={sigenCoordinate3[index][1]} width={imageSize} height={imageSize} />

...
const imageLabelSize = defineImageLabelSize() / 3
...
export const App = () => {
  ...
  return (
    ...
    <Button variant='contained' onClick={()=>setSeaView((prev)=>prev*(-1)+1)} data-item={'sea'}>{seaButtonText}</Button> */}
      ...
      {/* <Grid container item xs={12 / 8} sx={{ direction: 'row' }}></Grid> */}

      {/* test */}
      <Grid container direction='row'>
        <Grid container item xs={4} direction='column'  >
          <Grid container item xs={4} direction='row' alignContent='center'>
            <Grid item xs={4}>
      ...
      <Grid container direction='row'>
        ...
        <Grid container item xs={2} direction='column'  >
          ...
          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
            ...
            <Grid item xs={6} display='flex' justifyContent='center'>
              <h2 style={{ fontSize: imageLabelFontSize, display: 'flex', backgroundColor: 'red', alignItems: 'center' }}>レンガBrick</h2>
            </Grid>
          </Grid>
          <Grid container item xs={bonreiXs} direction='row' alignContent='center' >
            <Grid item xs={6} display='flex' justifyContent='center'>
      ...
      <Grid container direction='column' sx={{ height: '100vh' }}>
        <Grid container item xs={12 / 9} >
          <Button variant='contained' style={{ height: 'auto' }} onClick={(onClickViewButton)} data-item={'land'}>{landButtonText}</Button>
          <Button variant='contained' onClick={(onClickViewButton)} data-item={'sea'}>{seaButtonText}</Button>
          <Button variant="contained" onClick={() => setLoop((prev) => prev + 1)}>数字だけ変更</Button>
        </Grid>
        <Grid container item xs={12 / 9} >
        ...
        <Grid container item xs={12 / 9} sx={{ direction: 'row', minHeight: bonrei }}>

          <Grid item xs={12 / 8} sx={{ display: 'flex', justifyContent: 'space-around' }}>
      ...
      <Grid container direction='column' sx={{ minHeight: '100vh' }}>
        <Grid container item xs={12 / 8} sx={{ direction: 'column' }}>
          <Grid item xs={12 / 8} sx={{ display: 'flex', justifyContent: 'space-around' }}>
            <img src={img1png} width={imageLabelSize}></img>
          </Grid>
        </Grid>
        <Grid container item xs={12 / 8} sx={{ direction: 'row', minHeight: '12.5vh' }}>
